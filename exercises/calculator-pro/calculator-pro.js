function calculatorPro() {
  ...
  if (numberList.length == 1) {
    alert(
      "The result of square root is " + Math.sqrt(numberList[0]).toFixed(3)
    );
  } else {
    ...
    for (let i = 1; i < numberList.length; i++) {
      ...
      alert("Results:");
      alert("The result of the sum is " + resultSum.toFixed(3));
      alert("The result of the rest is " + resultRest.toFixed(3));
      alert(
        "The result of the multiplication is " + resultMultiplication.toFixed(3)
      );
      alert("The result of the division is " + resultDivision.toFixed(3));
    }
  }
